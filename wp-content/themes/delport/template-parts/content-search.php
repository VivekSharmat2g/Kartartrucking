...
?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('ablog ablog-4 mb-60 format-search'); ?>>
...
<?php
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('bd-blog mb-60 format-search'); ?> data-wow-delay=".3s">
        <?php if (has_post_thumbnail()) : ?>
        ...
        <div class="bd-blog-text">
            <div class="bd-blog-meta mb-20">
                <ul>
                    ...
                    <?php endif; ?>
                    <?php if (!empty($delport_blog_comments)) : ?>
                        <li><a href="<?php comments_link(); ?>"> <i class="fas fa-comments"></i></i> <?php comments_number(); ?></a></li>
                    <?php endif; ?>
                </ul>
            </div>
