...
?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('ablog ablog-4 mb-60 format-image'); ?>>
...
<?php else : ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('bd-blog mb-60 format-image'); ?> data-wow-delay=".3s">
        <?php if (has_post_thumbnail()) : ?>
