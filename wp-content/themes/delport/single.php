...
<section class="blog-area blog-details-area pt-120 pb-90">
									...
									<?php
			                            ...
			                            <div class="col-lg-6 col-md-6">
			                                <div class="theme-navigation b-next-post text-left mb-30">
			                                    <span><?php print esc_html__( 'Prev Post', 'delport' );?></span>
								...
								<?php
		                            ...
		                            <div class="col-lg-6 col-md-6">
		                                <div class="theme-navigation b-next-post text-left text-md-right  mb-30">
		                                    <span><?php print esc_html__( 'Next Post', 'delport' );?></span>
