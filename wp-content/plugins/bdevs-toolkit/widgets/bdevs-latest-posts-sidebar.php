...
class Latest_posts_sidebar_Widget extends WP_Widget
{
	...
	{
		parent::__construct('bdevs-latest-posts', 'Delport Sidebar Posts Image', [
			'description' => 'Latest Post Widget by Delport',
		]);
	}
							...
							<?php if (has_post_thumbnail()) : ?>
								<div class="rc-thumb mr-20">
									<a href="<?php the_permalink(); ?>">
										<div class="sidebar-posts-bg-thumb" data-background="<?php print esc_url(get_the_post_thumbnail_url(get_the_ID(), 'full')); ?>"></div>
									</a>
								</div>
							<?php endif; ?>
