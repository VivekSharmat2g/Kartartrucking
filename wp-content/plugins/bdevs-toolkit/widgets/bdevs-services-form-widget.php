...
class bdevs_services_form_widget extends WP_Widget
{
    ...
    {
        parent::__construct('bdevs_services_form_widget', esc_html__('Delport Services Form', 'bdevs-toolkit'), [
            'description' => esc_html__('Delport Services Form Widget', 'bdevs-toolkit'),
        ]);
    }
