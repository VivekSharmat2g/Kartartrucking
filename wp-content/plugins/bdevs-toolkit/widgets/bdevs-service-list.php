...
class Latest_Services_List_Widget extends WP_Widget
{
	...
	{
		parent::__construct('bdevs-services-cats', 'Delport Services List', array(
			'description'	=> 'Delport Services List'
		));
	}
	...
	public function widget($args, $instance)
	{
		...
		<?php endif; ?>
         ...
         <ul class="widget-services">
				...
				?>
               	<li class="dp-service-title-list"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></li>
               	<?php
						$i += 1;
					endwhile;
					wp_reset_query();
