...
class Assets
{
    ...
    public function register_js()
    {
        ...
        wp_register_script('bdevs-elementor-flaticon', BDEVS_ELEMENTOR_ASSETS . '/fonts/bdevs-elementor-flaticon.js', [], BDEVS_ELEMENTOR_VERSION, true);
    }
    ...
    public function register_css()
    {
        ...
        wp_register_style('bdevs-elementor-flaticon', BDEVS_ELEMENTOR_ASSETS . '/fonts/css/bdevs-elementor-flaticon.css', [], BDEVS_ELEMENTOR_VERSION, false);
    }
