...
class Project extends \Generic\Elements\GenericWidget {
    ...
    protected function render()
    {
        ...
        <section class="featured-gallery-area d-none">
            <div class="container">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-5">
                        ...
                        <?php endif; ?>
                        <div class="hero-title-two mb-20">
                            <?php
                                if ($settings['title']) :
                                    printf(
                                        '<%1$s %2$s>%3$s</%1$s>',
                    ...
                    <div class="col-xl-7">
                        <div class="case-study-right-tab-area d-flex justify-content-end align-items-center">
                           <div class="case-study-filter-content">
                            <nav>
                             <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link <?php echo ($tab['active_tab'] == 'yes') ? 'active' : ''; ?>" id="nav-<?php echo $tab_title; ?>" data-bs-toggle="tab" data-bs-target="#nav-<?php echo $tab_title; ?>" type="button" role="tab" aria-controls="nav-<?php echo $tab_title; ?>" aria-selected="true"><?php echo wp_kses_post($tab['title']); ?></button>
                           ...
                           <div class="case-study-nav-gradin">
                               <div class="case-study-two-button-prev"><i class="far fa-long-arrow-left"></i></div>
