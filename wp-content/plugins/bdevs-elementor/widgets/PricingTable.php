...
class PricingTable extends \Generic\Elements\GenericWidget
{
    ...
    protected function pricing_features_control(){
        ...
        $this->add_control(
            'features_switch',
            [
                'label' => esc_html__('Features On/Off Switch', 'bdevs-elementor'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'bdevs-elementor'),
                'label_off' => esc_html__('Hide', 'bdevs-elementor'),
                'return_value' => 'yes',
    ...
    protected function pricing_content_style_controls(){
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-pricing-box' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdevs-el-pricing-box',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-pricing-box' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-pricing-box:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle'    => true,
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-pricing-box, {{WRAPPER}} .gen-price-package-general .bdevs-el-package-price, {{WRAPPER}} .bdevs-el-package-price' => 'text-align: {{VALUE}};', '{{VALUE}}',
                ],
    ...
    protected function pricing_header_style_controls(){
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-package-name' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-package-name' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdevs-el-package-name',
            ]
        );
    ...
    protected function pricing_style_controls(){
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-package-price' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-package-price' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdevs-el-package-price',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-currency' => 'margin-right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-currency' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdevs-el-currency',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-price-period' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-price-period' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdevs-el-price-period',
            ]
        );
    ...
    protected function pricing_features_style_controls(){
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-price-features-list' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-price-features-list' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdevs-el-price-features-list',
            ]
        );
        $this->end_controls_section();
    }
    ...
    protected function pricing_badge_style_controls(){
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-pricing-badge' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-pricing-badge' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-pricing-badge' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'badge_border',
                'selector' => '{{WRAPPER}} .bdevs-el-pricing-badge',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .bdevs-el-pricing-badge' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        <div class="gen-price-package gen-price-package-style-3 mb-30 bdevs-el-pricing-box <?php echo $settings['active_price'] ? 'package-popular': ''; ?>">

            <div class="gen-pricing-header">
                <?php if (!empty($settings['plan_name'])) : ?>
                    <h4 class="bdevs-el-package-name"><?php echo wp_kses_post($settings['plan_name']); ?></h4>
                <?php endif; ?>

                <span class="bdevs-el-package-price">
                    <span class="price-currency bdevs-el-currency"><?php echo esc_html($currency); ?></span>
                    <?php echo wp_kses_post($settings['price']); ?>
                    <span class="additional-points bdevs-el-price-period"><?php echo wp_kses_post($settings['period']); ?></span>
                </span>
            </div>
                    ...
                    <ul>
                        ...
                        ?>
                            <?php if(!empty($feature['text'])) : ?>
                                <li class="bdevs-el-price-features-list"><?php echo wp_kses_post($feature['text']); ?></li>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </ul>
                </div>
    ...
    ?>
        ...
        <div class="gen-price-package gen-price-package-style-2 bdevs-el-pricing-box <?php echo $settings['active_price'] ? 'package-popular': ''; ?> ">
            <div class="gen-pricing-header">
            ...
            <div class="gen-pricing-content">
                ...
                <span class="bdevs-el-package-price">
                    <span class="price-currency bdevs-el-currency"><?php echo esc_html($currency); ?></span>
                    <?php echo wp_kses_post($settings['price']); ?>
                    <span class="price-period bdevs-el-price-period"><?php echo wp_kses_post($settings['period']); ?></span>
                </span>
    ...
    <?php else:
        ...
        $class_name = $settings['active_price'] ? 'active' : '';
        $this->add_inline_editing_attributes('button_footer', 'none');
        $this->add_render_attribute('button_footer', 'class', 'fill-btn clip-btn bdevs-el-btn');
        $this->add_link_attributes('button_footer', $settings['button_link']);
        ?>

        <div class="pricing__box bdevs-el-pricing-box mb-50 wow fadeInUp <?php echo $settings['active_price'] ? 'active': ''; ?>" data-wow-duration="1.5s" data-wow-delay=".3s">
            <div class="pricing__header">

                <?php if (!empty($settings['badge_text'])) : ?>
                <div class="pricing__badge bdevs-el-pricing-badge">
                    <span><?php echo wp_kses_post($settings['badge_text']); ?></span>
                </div>
                <?php endif; ?>

                <?php if (!empty($settings['plan_name'])) : ?>
                    <h4 class="pricing__package-name bdevs-el-package-name"><?php echo wp_kses_post($settings['plan_name']); ?></h4>
                <?php endif; ?>

                <span class="pricing__package-price bdevs-el-package-price">
                    <span class="pricing__package-currency"><?php echo esc_html($currency); ?></span><?php echo wp_kses_post($settings['price']); ?>
                    <span class="pricing__package-period"><?php echo wp_kses_post($settings['period']); ?></span>
                </span>
