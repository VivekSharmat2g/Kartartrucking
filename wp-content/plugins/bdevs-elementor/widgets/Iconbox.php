...
class Iconbox extends \Generic\Elements\GenericWidget
{
    ...
    {
        return __('Iconbox', 'bdevs-elementoror');
    }
    ...
    {
        return ['bootstrap', 'magnific-popup', 'genwow', 'bdevs-elementoror-js'];
    }

    public function get_style_depends()
    {
        return ['bootstrap', 'magnific-popup', 'fontawesome', 'bdevs-elementoror-css', 'bdevs-elementoror-flaticon', 'gen-editor-pro'];
    }
    ...
    public function icon_image()
    {
        ...
        $this->add_control(
            'image',
            [
                'label' => __( 'Image', 'bdevs-elementoror' ),
    ...
    public function iconbox_content()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Content', 'bdevs-elementoror' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'number',
            [
                'label' => __( 'Number', 'bdevs-elementoror' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __( 'Number', 'bdevs-elementoror' ),
                'dynamic' => [
                    'active' => true,
                ],
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __( 'Icon Box', 'bdevs-elementoror' ),
                'placeholder' => __( 'Type Icon Box Title', 'bdevs-elementoror' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => __( 'Icon Description', 'bdevs-elementoror' ),
                'dynamic' => [
                    'active' => true,
                ],
                'condition' => [
        ...
        $this->add_control(
            'svg_icon',
            [
                'label' => __( 'SVG', 'bdevs-elementoror' ),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'label_block' => true,
                'placeholder' => __( 'Icon Description', 'bdevs-elementoror' ),
                'dynamic' => [
        ...
        $this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [
						'title' => __( 'Justify', 'bdevs-elementoror' ),
    ...
    protected function button_content_controls() {
		...
		$this->start_controls_section(
			'_section_button',
			[
				'label' => __( 'Button', 'bdevs-elementoror' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
                'condition' => [
                    'designs' => ['design_10'],
                ],
		...
		$this->add_control(
			'button_text',
			[
				'label' => __( 'Text', 'bdevs-elementoror' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'Button Text',
				'placeholder' => __( 'Type button text here', 'bdevs-elementoror' ),
				'label_block' => true,
				'dynamic' => [
					'active' => true,
				]
		...
		$this->add_control(
			'button_link',
			[
				'label' => __( 'Link', 'bdevs-elementoror' ),
		...
		$this->add_control(
			'button_fullwidth',
			[
				'label' => __( 'Full Width?', 'bdevs-elementoror' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'stretch' => [
						'title' => __( 'Stretch', 'bdevs-elementoror' ),
						'icon' => 'eicon-text-align-justify',
					],
				],
				'toggle' => false,
		...
		$this->add_control(
			...
			[
				'label' => __( 'Icon Position', 'bdevs-elementoror' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'label_block' => false,
				'options' => [
					'before' => __( 'Before Text', 'bdevs-elementoror' ),
					'after' => __( 'After Text', 'bdevs-elementoror' ),
				],
				'default' => 'before',
				'toggle' => false,
				'style_transfer' => true,
		...
		$this->add_control(
			'button_icon_spacing',
			[
				'label' => __( 'Icon Spacing', 'bdevs-elementoror' ),
    ...
    protected function icon_style_controls() {
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => __( 'Size', 'bdevs-elementoror' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->add_control(
			'offset_toggle',
			[
				'label' => __( 'Offset', 'bdevs-elementoror' ),
				'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
				'label_off' => __( 'None', 'bdevs-elementoror' ),
				'label_on' => __( 'Custom', 'bdevs-elementoror' ),
				'return_value' => 'yes',
			]
		);
        $this->start_popover();
		...
		$this->add_responsive_control(
			'media_offset_x',
			[
				'label' => __( 'Offset Left', 'bdevs-elementoror' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'condition' => [
					'offset_toggle' => 'yes'
		...
		$this->add_responsive_control(
			'media_offset_y',
			[
				'label' => __( 'Offset Top', 'bdevs-elementoror' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'condition' => [
					'offset_toggle' => 'yes'
		...
		$this->add_responsive_control(
			'icon_padding',
			[
				'label' => __( 'Padding', 'bdevs-elementoror' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'selectors' => [
		...
		$this->add_responsive_control(
			'icon_border_radius',
			[
				'label' => __( 'Border Radius', 'bdevs-elementoror' ),
		...
		$this->start_controls_tab(
			'_tab_icon_normal',
			[
				'label' => __( 'Normal', 'bdevs-elementoror' ),
			]
		);
		...
		$this->add_control(
			'icon_color',
			[
				'label' => __( 'Color', 'bdevs-elementoror' ),
        ...
        $this->add_group_control(
			...
			[
				'name' => 'background',
				'label' => esc_html__( 'Background', 'bdevs-elementoror' ),
		...
		$this->add_control(
			'icon_bg_rotate',
			[
				'label' => __( 'Rotate Icon Box', 'bdevs-elementoror' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'deg' ],
				'default' => [
					'unit' => 'deg',
		...
		$this->start_controls_tab(
			...
			[
				'label' => __( 'Hover', 'bdevs-elementoror' ),
			]
		);
		...
		$this->add_control(
			'icon_hover_bg_color',
			[
				'label' => __( 'Background Color', 'bdevs-elementoror' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Border Color', 'bdevs-elementoror' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
