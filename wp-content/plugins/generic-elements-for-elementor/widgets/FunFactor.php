...
class FunFactor extends GenericWidget
{
	...
	protected function fun_factor_content_controls()
	{
		...
		$repeater->add_control(
			'fun_factor_data_count',
			[
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'label' => esc_html__('Data Count Number', 'generic-elements'),
				'default' => esc_html__('50', 'generic-elements'),
				'placeholder' => esc_html__('Type Data Count', 'generic-elements'),
				'dynamic' => [
					'active' => true,
				]
			]
...
?>
		<section class="generic-funfact-area bdevs-generic-el">
			<div class="container">
				<div class="row">
					...
					?>
						<div class="col-xl-3 col-lg-3 col-md-6 col-12">
							<div class="generic-el-funfact-wrapper mb-30">
								<div class="generic-funfact-content">
									...
									<?php if (!empty($slide['fun_factor_number'])) : ?>
										<h2 class="generic-funfact-number"><span class="odometer" data-count="<?php echo wp_kses_post($slide['fun_factor_data_count']); ?>"> <?php echo wp_kses_post($slide['fun_factor_number']); ?> </span><?php echo wp_kses_post($slide['fun_factor_number_sign']); ?></h2>
									<?php endif; ?>
