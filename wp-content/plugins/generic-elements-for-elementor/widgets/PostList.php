...
class PostList extends GenericWidget
{
    ...
    {
        return ['generic-element-css', 'bootstrap', 'fontawesome', 'gen-flaticon'];
    }
    ...
    public function blog_list()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors' => [
                    '{{WRAPPER}} .gen-default-bd-blog-text' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .gen-default-bd-blog-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .gen-default-bd-blog-text',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .gen-default-bd-blog',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .gen-default-bd-blog' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    public function blog_title()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .gen-default-blog-area .gen-default-bd-blog-title2:hover > a ' => 'color: {{VALUE}}',
                ],
            ]
        );
    ...
    public function blog_meta()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .gen-default-bd-blog-meta ul li, .gen-default-bd-blog-meta ul li a' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .gen-default-bd-blog-meta ul li i, .gen-default-bd-blog-meta ul li a i' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .gen-default-bd-blog-meta ul li a:hover ' => 'color: {{VALUE}}',
                ],
            ]
        );
    ...
    public function blog_author()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Typography', 'generic-elements'),
                'selector' => '{{WRAPPER}} .gen-default-bd-blog-author-info-title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .gen-default-bd-blog-author-info-title' => 'color: {{VALUE}}',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('title', 'class', 'gen-default-bd-blog-title2 mb-40 generic-el-title');
        $title = wp_kses_post($settings['title'] ?? '');
        if (!empty($posts)) : ?>

            <section class="bdevs-generic-el gen-default-blog-area">
                <div class="container">
                    <div class="row">
                        <?php foreach ($posts as $inx => $post) : ?>
                            <div class="col-lg-4 col-md-6">
                                <div class="gen-default-bd-blog mb-30">
                                    <?php if (('yes' === $feature_image) && !empty(get_the_post_thumbnail_url($post->ID, 'full'))) : ?>
                                        <div class="gen-default-bd-blog-img">
                                            <a href="<?php echo esc_url(get_the_permalink($post->ID)); ?>"><img src="<?php print get_the_post_thumbnail_url($post->ID, 'full'); ?>" alt=""></a>
                                        </div>
                                    <?php endif; ?>
                                    <div class="gen-default-bd-blog-text">
                                        <div class="gen-default-bd-blog-meta mb-15">
                                            <ul>
                                        ...
                                        <div class="gen-default-bd-blog-author">
                                            <div class="gen-default-bd-blog-author-info">
                                                <?php echo get_avatar($post->post_author); ?>
                                                <h6 class="gen-default-bd-blog-author-info-title"><?php echo get_the_author_meta('nicename', $post->post_author);  ?></h6>
                                            </div>
                                            <div class="gen-default-bd-blog-author-link">
